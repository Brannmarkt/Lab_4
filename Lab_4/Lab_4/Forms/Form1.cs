...
namespace Lab_4
{
    public partial class Form1 : Form
    {
        ...
        readonly private string _pathToTeachersDataFile = @"E:\Projects\Lab_4\Teachers.json";
        readonly private string _pathToDisciplinesDataFile = @"E:\Projects\Lab_4\Disciplines.json";
        ...
        private void AddTeacherButton_Click(object sender, EventArgs e)
        {
            if (TeacherTextBox.Text != "" && SalaryTextBox.Text != "") 
            {
                try
                {
                    ...
                    Teacher new_teacher = new Teacher(name, salary);
                    Add(new_teacher);
